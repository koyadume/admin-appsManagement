...
@Getter @Setter
@AnnoPluginForm(name = AppDetailsPluginForm.FORM_NAME)
public class AppDetailsPluginForm extends ResPluginForm {

	public static final String FORM_NAME = "appDetails";
